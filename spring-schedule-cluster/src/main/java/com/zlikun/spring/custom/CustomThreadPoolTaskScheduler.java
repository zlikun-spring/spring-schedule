 ...
 * @date 2017/10/19 20:30
 */
@Slf4j
public class CustomThreadPoolTaskScheduler extends ExecutorConfigurationSupport
    ...
    public ScheduledFuture<?> schedule(Runnable task, Trigger trigger) {
        log.info("join schedule process ...");
    ...
    static class ReschedulingRunnable extends DelegatingErrorHandlingRunnable implements ScheduledFuture<Object> {
